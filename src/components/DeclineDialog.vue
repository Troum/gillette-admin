...
<script>
    export default {
        ...
        data() {
            return {
                ...
                reasons: [
                    ...
                    {
                        label: 'данный чек уже принял участие в розыгрыше',
                        value: 4
                    },
                    {
                    ...
                    {
                        label: 'в чеке должны быть видны наименованиие товара',
                        value: 6
                    }
                ]
            }
        ...
        methods: {
            submit() {
                this.form.user_id = this.$store.getters.decline.data.participant_id;
